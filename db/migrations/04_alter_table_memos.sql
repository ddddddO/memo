...
CREATE FUNCTION update_updated_at_function() RETURNS trigger AS $$
    BEGIN
    ...
    END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER update_updated_at_trigger BEFORE UPDATE OF content ON memos
    FOR ROW EXECUTE FUNCTION update_updated_at_function();
